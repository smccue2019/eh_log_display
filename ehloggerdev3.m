%% eH Logger
% Real time monitoring and logging of Koichi Nakamura's eH probe.
% Features:
% Most recent value and time as text in a dialog box.
% Running plot of measurements.
% Automatic periodic saves of the timeseries. Period defined by variable 'filewriteperiod'.
% Auto save of timeseries and killing of script at closing of plot or text window.and
% Scott McCue WHOI/AOPE smccue@whoi.edu June 2017.
%
...
%% Set port ID
% To externally confirm to which port the USB adapter/eh probe is connected,
% use the MSWindows util at ControlPanel->System->DeviceManager->Ports
ports_list = instrhwinfo('serial');
port_str = 'COM8';
